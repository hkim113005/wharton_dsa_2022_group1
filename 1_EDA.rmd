...
pdf("images/artist_pop_distribution.pdf")
pop_dist
dev.off()
...
pdf("images/hitness_vs_artist_pop.pdf")
artist_pop
dev.off()
...
pdf("images/hitness_vs_artist_pop_(highlighted_top_30).pdf")
pop_w_top 
dev.off()
```
...
pdf("images/hitness_vs_danceability.pdf")
dance
dev.off()
...
pdf("hitness_vs_acousticness.pdf")
acoustic
dev.off()
...
pdf("hitness_vs_speechiness.pdf")
speech
dev.off()
...
loudness <- song_df %>% ggplot(aes(x = instrumentalness, y = hitness)) +
  geom_point(color = "#2DB9F4") + 
